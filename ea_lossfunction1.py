...
def unet_model(n_classes=255, im_sz=128, n_channels=7, n_filters_start=64, growth_factor=2, upconv=True,
    ...
    model.compile(optimizer=Adam(lr=0.1), loss=weighted_binary_crossentropy,)
    return model
